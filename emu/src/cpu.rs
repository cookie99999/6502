...
const INSTR_SET_NMOS: [Instruction; 256] = instr_set![
    {0x00, 1, 7, AddrMode::Impl, "BRK"}, {0x01, 2, 6, AddrMode::XInd, "ORA"}, {0x02, 1, 0, AddrMode::Impl, "*JAM"}, {0x03, 2, 8, AddrMode::XInd, "*SLO"},
  ...
  {0x10, 2, 2, AddrMode::Rel, "BPL"}, {0x11, 2, 5, AddrMode::IndY, "ORA"}, {0x12, 1, 0, AddrMode::Impl, "*JAM"}, {0x13, 2, 8, AddrMode::IndY, "*SLO"},
  ...
  {0x20, 3, 6, AddrMode::Abs, "JSR"}, {0x21, 2, 6, AddrMode::XInd, "AND"}, {0x22, 1, 0, AddrMode::Impl, "*JAM"}, {0x23, 2, 8, AddrMode::XInd, "*RLA"},
  ...
  {0x30, 2, 2, AddrMode::Rel, "BMI"}, {0x31, 2, 5, AddrMode::IndY, "AND"}, {0x32, 1, 0, AddrMode::Impl, "*JAM"}, {0x33, 2, 8, AddrMode::IndY, "*RLA"},
  ...
  {0x40, 1, 6, AddrMode::Impl, "RTI"}, {0x41, 2, 6, AddrMode::XInd, "EOR"}, {0x42, 1, 0, AddrMode::Impl, "*JAM"}, {0x43, 2, 8, AddrMode::XInd, "*SRE"},
  ...
  {0x50, 2, 2, AddrMode::Rel, "BVC"}, {0x51, 2, 5, AddrMode::IndY, "EOR"}, {0x52, 1, 0, AddrMode::Impl, "*JAM"}, {0x53, 2, 8, AddrMode::IndY, "*SRE"},
  ...
  {0x60, 1, 6, AddrMode::Impl, "RTS"}, {0x61, 2, 6, AddrMode::XInd, "ADC"}, {0x62, 1, 0, AddrMode::Impl, "*JAM"}, {0x63, 2, 8, AddrMode::XInd, "*RRA"},
  ...
  {0x70, 2, 2, AddrMode::Rel, "BVS"}, {0x71, 2, 5, AddrMode::IndY, "ADC"}, {0x72, 1, 0, AddrMode::Impl, "*JAM"}, {0x73, 2, 8, AddrMode::IndY, "*RRA"},
  ...
  {0x90, 2, 2, AddrMode::Rel, "BCC"}, {0x91, 2, 6, AddrMode::IndY, "STA"}, {0x92, 1, 0, AddrMode::Impl, "*JAM"}, {0x93, 2, 6, AddrMode::IndY, "*SHA"},
  ...
  {0xb0, 2, 2, AddrMode::Rel, "BCS"}, {0xb1, 2, 5, AddrMode::IndY, "LDA"}, {0xb2, 1, 0, AddrMode::Impl, "*JAM"}, {0xb3, 2, 5, AddrMode::IndY, "*LAX"},
  ...
  {0xd0, 2, 2, AddrMode::Rel, "BNE"}, {0xd1, 2, 5, AddrMode::IndY, "CMP"}, {0xd2, 1, 0, AddrMode::Impl, "*JAM"}, {0xd3, 2, 8, AddrMode::IndY, "*DCP"},
  ...
  {0xf0, 2, 2, AddrMode::Rel, "BEQ"}, {0xf1, 2, 5, AddrMode::IndY, "SBC"}, {0xf2, 1, 0, AddrMode::Impl, "*JAM"}, {0xf3, 2, 8, AddrMode::IndY, "*ISC"},
...
impl Cpu {
	...
	print!(" A:{:02X} X:{:02X} Y:{:02X} P:{:02X} SP:{:02X} PPU:{},{} CYC:{}\n", self.a, self.x, self.y, self.p.as_u8(), self.sp, self.bus.ppu.scanline, self.bus.ppu.pixel, self.cycles);
    }
	...
	self.cycles - oldcycles //0 will cause exit
    }
}
